...
//    [self setTitle:NSEaseLocalizedString(@"ui.downloadComplete", @"Download complete") forState:MJRefreshStateNoMoreData];
    ...
    [self setTitle:@"Pull up to download more" forState:MJRefreshStateIdle];
    [self setTitle:@"Release to download" forState:MJRefreshStatePulling];
    [self setTitle:@"Downloading more..." forState:MJRefreshStateRefreshing];
    [self setTitle:@"Download complete" forState:MJRefreshStateNoMoreData];
}
